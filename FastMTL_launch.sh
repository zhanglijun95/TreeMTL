...
######## exp settings #########
exp_dir=FastMTL_0405/
layout_idx=0 #no value: select the layout with the lowest merging cost; int: selected layout
declare -a argcombinations=(
# backbone align mtl_load jobname
"mobilenet no no MNN"
"mobilenet no no_merged_only MNNM"
"mobilenet no merged_only MNM"
"mobilenet no all MNA"
"mobilenet simple no MSN"
"mobilenet simple no_merged_only MSNM"
"mobilenet simple merged_only MSM"
"mobilenet simple all MSA"
"mobilenet complex no MCN"
"mobilenet complex no_merged_only MCNM"
"mobilenet complex merged_only MCM"
"mobilenet complex all MCA"
)
