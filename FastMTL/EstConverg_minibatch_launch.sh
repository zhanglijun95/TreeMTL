...
######## exp settings #########
exp_dir=FastMTL_0516/
load_weight=true
declare -a argcombinations=(
# backbone short_iters start step smooth_weight jobname
# "mobilenet 100 0 25 0.6 1h"
"mobilenet 200 0 50 0.6 2h"
# "mobilenet 200 0 50 0.4 2h_2"
# "mobilenet 2000 0 500 0.0 2k"
# "mobilenet 2000 0 500 0.4 2k_2"
)
...
for argcombination in "${argcombinations[@]}"; do
    ...
    if ${load_weight}; then
        ...
        --smooth_weight ${smooth_weight} --batch_num ${batch_num}
    else
